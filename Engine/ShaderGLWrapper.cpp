...
ShaderGLWrapper::ShaderGLWrapper(const std::string& fileName, ShaderManager &shaderManager)
...
ShaderGLWrapper::~ShaderGLWrapper()
{
	for (auto shader : mShaders)
	{
...
void ShaderGLWrapper::SetModelViewProjectionMatrixUniform(glm::mat4 mvp)
{
...
std::string ShaderGLWrapper::loadShader(const std::string &fileName)
{
	std::ifstream file;
...
GLuint ShaderGLWrapper::createShader(const std::string &fullText, GLenum shaderType)
{
